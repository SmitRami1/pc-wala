...
<div class="row row-cols-1 row-cols-md-2 g-4">
  <div class="col">
    <div class="card card1">
      <img src="../Images/i3.jpg" class="card-img-top" alt="..." id="pros1">
    </div>
  </div>
  <div class="col">
    <div class="card card2">
      <img src="../Images/i3.jpg" class="card-img-top" alt="..." id="pros2">
    </div>
  </div>
  <div class="col">
    <div class="card card3">
      <img src="../Images/i3.jpg" class="card-img-top" alt="..." id="pros3">
    </div>
  </div>
  <div class="col">
    <div class="card card4">
      <img src="../Images/i3.jpg" class="card-img-top" alt="..."id="pros4">
    </div>
  </div>
</div>
<div class="row row-cols-1 row-cols-md-2 g-4">
